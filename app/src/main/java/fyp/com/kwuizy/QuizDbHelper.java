//This Java class creates the Database, all questions, choices and answers
...
import fyp.com.kwuizy.QuizContract.*;

import java.util.ArrayList;
import java.util.List;

public class QuizDbHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "Kwuizy.db";
...
//DataBase Construction
    ...
    //updates db with newest version
    @Override
    ...
    //Fills the questions choices and answer
    private void fillQuestionsTable() {
        ...
        Question q6 = new Question("Non existing, Medium: A is correct",
                "A", "B", "C", 2, Question.DIFFICULTY_EASY, 5);
        insertQuestion(q6);
...
//Adds in content. Each automatically given ID
    ...
    //read categories from database and returns them as list
    ...
    //Get all question to array in application
    ...
    public ArrayList<Question> getQuestions(int categoryID, String difficulty){
        ...
        //Filter category questions at set difficulty level
